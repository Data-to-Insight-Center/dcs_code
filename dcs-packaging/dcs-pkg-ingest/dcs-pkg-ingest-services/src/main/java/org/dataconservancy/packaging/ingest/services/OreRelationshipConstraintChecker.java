 ...
 */
public class OreRelationshipConstraintChecker extends BaseOreChecker {
    ...
    public OreRelationshipConstraintChecker() {

    }

    public OreRelationshipConstraintChecker(List<String> errors) {
        super(errors);
    }
    ...
    protected void checkAggregation(String aggregatingType, String aggregatedType, String aggregatingRelationship,
        ...
        if (aggregatedType.equals(ORE_REM_DATAITEM)) {
            ...
            if (aggregatingType.equals(ORE_REM_PACKAGE)) {
                final Set<AttributeSet> packagesAs = asm.matches(AttributeSetUtil.ORE_PACKAGE_MATCHER);
                ...
                for (String dataItemResourceId : values(packageAs, PACKAGE_AGGREGATES_DATAITEM)) {
                    AttributeSet dataItemAs = asm.getAttributeSet(composeKey(ORE_REM_DATAITEM, dataItemResourceId));
                ...
                Set<AttributeSet> collectionsAs = asm.matches(AttributeSetUtil.ORE_COLLECTION_MATCHER);
